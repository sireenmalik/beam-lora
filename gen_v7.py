"""
gen_v7.py — training data for the fan_center adapter.
...
Usage:
    python gen_v7.py                 # writes train_v7.jsonl + prints diagnostics
    python gen_v7.py --n 2000        # more samples
"""
...
def main():
    ...
    ap.add_argument("--out", default="train_v7.jsonl")
    a = ap.parse_args()

"""
train_v8.py — LoRA fine-tune for the fan_center adapter.

Reads train_v8.jsonl produced by gen_v8.py. It does NOT generate data itself:
...
Run:
    python gen_v8.py --n 1500      # first, and read the diagnostics
...
if not os.path.exists(DATA):
    raise SystemExit(f"{DATA} not found. Run:  python gen_v8.py --n 1500")
